...
export default function Hero() {
  return (
  <section className="relative w-full h-[calc(100vh-64px)] flex flex-col justify-center items-center bg-gradient-to-br from-blue-600 via-blue-300 to-white overflow-hidden py-4">
      <div className="absolute inset-0 z-0 animate-gradient-x">
        <svg width="100%" height="100%" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill="#1976d2" fillOpacity="0.15" d="M0,160L48,165.3C96,171,192,181,288,165.3C384,149,480,107,576,117.3C672,128,768,192,864,218.7C960,245,1056,235,1152,208C1248,181,1344,139,1392,117.3L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div>
  ...
  <p className="text-sm sm:text-base text-[color:rgba(15,23,42,0.8)] mb-6 sm:mb-8 animate-fade-in">A bold new platform built to streamline operations, delight customers, and empower teams. Sign up for early access.</p>
        <div className="flex flex-col gap-6 justify-center mb-8 animate-fade-in">
          <div className="text-center">
            <p className="text-lg text-blue-800 font-semibold mb-3">Launching soon</p>
