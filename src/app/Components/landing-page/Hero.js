...
export default function Hero() {
  return (
  <section className="relative w-full h-[calc(100vh-64px)] flex flex-col justify-center items-center hero-bg overflow-hidden py-4">
  ...
  <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold drop-shadow mb-3 sm:mb-5 animate-fade-in">
    ...
    <Image src="/zestro-logo.png" alt="Zestro" width={240} height={72} className="mx-auto" />
  </h1>
